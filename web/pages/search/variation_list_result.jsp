		  ...
		  <div class="panel-body" style="padding-top:0px;padding-bottom:0px;" >
			...
			<div class="panel panel-default">
				 <div class="panel-body" style=" padding-bottom: 10px;">
					...
					<h4><a href="/gvk/browse/getVariation?param=<s:property value='#genotypeBean.genotypeId'/>&param1=<s:property value='searchSpecies'/>"><s:property value="#genotypeBean.varId"/></a> (Variant)</h4>
			...
			<s:if test="(genotypeBeanList == null || genotypeBeanList.size()==0 )&& (mapGeneBeanList==null||  mapGeneBeanList.size()==0 )">
