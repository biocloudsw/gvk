...
<div class="container">
	...
	<div class="row">
			...
			<div class="panel panel-default">
				...
				<div id="idResults" class="panel-collapse collapse in">
					 <div class="panel-body" style="font-size:14px;">
					 		<h5>Genes: <s:if test="mmapGeneCount>0"><a href="/gvk/fuzzyGeneSearch?searchParam=<s:property value='searchParam'/>&searchSpecies=<s:property value='searchSpecies'/>&mmapGeneCount=<s:property value='mmapGeneCount' />"><s:property value="mmapGeneCount" /></a></s:if><s:else>0</s:else></h5>
							<h5>Variants: <s:if test="mgenotypeCount>0"><a href="/gvk/fuzzyVariationSearch?searchParam=<s:property value='searchParam'/>&searchSpecies=<s:property value='searchSpecies'/>&mgenotypeCount=<s:property value='mgenotypeCount' />"><s:property value="mgenotypeCount" /></a></s:if><s:else>0</s:else></h5>
					 </div>
				</div>
			</div> 
        ...
        <div id="result" class="col-md-9" style="padding-top: 15px">
			<s:if test="genotypeBeanList != null ">
			<s:iterator id="genotypeBean" value="genotypeBeanList">
			<div class="panel panel-default">
				 <div class="panel-body">
				 
					<h4><a href="/gvk/browse/getVariation?param=<s:property value='#genotypeBean.genotypeId'/>&param1=<s:property value='searchSpecies'/>"><s:property value="#genotypeBean.varId"/></a></h4>
					<h5><strong>Location:</strong><s:property value="#genotypeBean.chrom"/>:<s:property value="#genotypeBean.startPos"/></h5>
				<!--	<s:if test="#genotypeBean.genotypeAnnotateGeneView != null ">
						<s:iterator id="genotypeAnnotate" value="#genotypeBean.genotypeAnnotateGeneView">
							<h5><strong>Consequence:</strong> <s:property value="#genotypeAnnotate.conseqtype"/><strong>     Mapped gene(s): <s:property value="#genotypeAnnotate.mapGeneId"/></strong></h5>
						</s:iterator>
					</s:if> -->
					<h5>Associations:<span class="label label-default"><s:property value="#genotypeBean.traitCount"/></span>&nbsp;&nbsp;&nbsp;&nbsp;Studies:<span class="label label-default"><s:property value="#genotypeBean.studyCount"/></span></h5>
				</div>
			</div>
			</s:iterator>
			</s:if>
