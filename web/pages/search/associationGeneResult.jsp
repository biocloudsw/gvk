						...
						<link href="/gvk/css/common.css" rel="stylesheet" />
							...
							<div class="fixed-table-toolbar">
							   ...
							   <div class="columns columns-left pull-left">
									...
									<button class="btn btn-default" onclick="window.location.href='/gvk/browse/getGeneAssociation?param=<s:property value="#parameters.param" />'"><s:property value="#itemCount.name" />( <s:property value="#itemCount.count" /> )</button>
