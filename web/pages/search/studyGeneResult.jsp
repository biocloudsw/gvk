...
<body>
						...
						<div class="fixed-table-toolbar">
							   ...
							   <div class="columns columns-left pull-left">
									...
									<button class="btn btn-default" onClick="window.location.href='/gvk/browse/getGeneStudy?param=<s:property value="#parameters.param" />'"><s:property value="#itemCount.name" />( <s:property value="#itemCount.count" /> )</button>
